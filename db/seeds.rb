...
w7 = Week.create(:name => 'Week 7', :study => ['Javascript Framework','Underscore','jQuery'])
w8 = Week.create(:name => 'Week 8', :study => ['Second Project - Group'])
w9 = Week.create(:name => 'Week 9', :study => ['Backbone', 'TDD', 'Minitest'])
w10 = Week.create(:name => 'Week 10', :study => ['Coffee Script','SCSS','Factroy Girl','Rspec','Cucumber','Regular Experession'])
